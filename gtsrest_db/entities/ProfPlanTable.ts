...
@Entity("PROF$PLAN_TABLE")
export class ProfPlanTable {
  @Column("varchar2", { name: "QBLOCK_NAME", nullable: true, length: 30 })
  qblockName: string | null;

  @Column("number", { name: "TIME", nullable: true, scale: 0 })
  time: number | null;

  @Column("varchar2", { name: "PROJECTION", nullable: true, length: 4000 })
  ...
  @Column("number", { name: "SEARCH_COLUMNS", nullable: true, scale: 0 })
